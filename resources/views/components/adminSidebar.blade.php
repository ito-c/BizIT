<div class="sidebar">
    <nav class="menu-lists">
        ...
        <ul>
            ...
            <li><a class="menu-list" href="{{ route('adminLike') }}">Like!</a></li>
            <li><a class="menu-list" href="{{ route('profile.index') }}">プロフィール</a></li>
            <li><a class="menu-list" href="{{ route('category_request.create') }}">カテゴリー申請</a></li>
        </ul>
        @if(Auth::user()->is_master())
            <p class="m-size">サイト管理者用</p>
            <ul>
                <li><a class="menu-list" href="{{ route('master_post.index') }}">投稿一覧</a></li>
                <li><a class="menu-list" href="{{ route('master_user.index') }}">ユーザー一覧</a></li>
